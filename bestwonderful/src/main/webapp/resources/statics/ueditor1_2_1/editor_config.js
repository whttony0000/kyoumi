...
(function () {
     ...
     */
    window.UEDITOR_HOME_URL = "../../resources/statics/ueditor1_2_1/";
    var tmp = window.location.pathname;
        URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("WebModel/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"../../../../imageUp/editorUp.do"             //图片上传提交地址
