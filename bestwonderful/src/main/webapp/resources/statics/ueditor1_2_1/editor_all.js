    ...
    EditorUI.prototype = {
        ...
        _updateFullScreen: function () {
            if ( this._fullscreen ) {
                ...
                uiUtils.setViewportOffset( this.getDom(), { left: 0, top: 110 } );
                this.editor.setHeight( vpRect.height - this.getDom( 'toolbarbox' ).offsetHeight - this.getDom( 'bottombar' ).offsetHeight -110 );
